...
namespace protocols.pubs
{
  ...
  public partial class ReadyBattleSpace : TBase
  {
    ...
    public ReadyBattleSpace()
    {
    }

    public ReadyBattleSpace DeepCopy()
    {
      var tmp72 = new ReadyBattleSpace();
      if((SpaceId != null) && __isset.spaceId)
      {
        tmp72.SpaceId = this.SpaceId;
      }
      tmp72.__isset.spaceId = this.__isset.spaceId;
      if((Uid != null) && __isset.@uid)
      {
        tmp72.Uid = this.Uid;
      }
      tmp72.__isset.@uid = this.__isset.@uid;
      if(__isset.@ready)
      {
        tmp72.Ready = this.Ready;
      }
      tmp72.__isset.@ready = this.__isset.@ready;
      return tmp72;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp73 = new TStruct("ReadyBattleSpace");
    ...
    {
      if (!(that is ReadyBattleSpace other)) return false;
    ...
    {
      var tmp75 = new StringBuilder("ReadyBattleSpace(");
      int tmp76 = 0;
      if((SpaceId != null) && __isset.spaceId)
      {
        if(0 < tmp76++) { tmp75.Append(", "); }
        tmp75.Append("SpaceId: ");
        SpaceId.ToString(tmp75);
      }
      if((Uid != null) && __isset.@uid)
      {
        if(0 < tmp76++) { tmp75.Append(", "); }
