...
namespace protocols.pubs
{
  ...
  public partial class RequsetStartBattleSpace : TBase
  {
    ...
    public RequsetStartBattleSpace()
    {
    }

    public RequsetStartBattleSpace DeepCopy()
    {
      var tmp87 = new RequsetStartBattleSpace();
      if((SpaceId != null) && __isset.spaceId)
      {
        tmp87.SpaceId = this.SpaceId;
      }
      tmp87.__isset.spaceId = this.__isset.spaceId;
      return tmp87;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp88 = new TStruct("RequsetStartBattleSpace");
    ...
    {
      if (!(that is RequsetStartBattleSpace other)) return false;
    ...
    {
      var tmp90 = new StringBuilder("RequsetStartBattleSpace(");
      int tmp91 = 0;
      if((SpaceId != null) && __isset.spaceId)
      {
        if(0 < tmp91++) { tmp90.Append(", "); }
        tmp90.Append("SpaceId: ");
        SpaceId.ToString(tmp90);
      }
      tmp90.Append(')');
