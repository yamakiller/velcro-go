...
{
  public static class login_serviceExtensions
  {
    ...
    public static Dictionary<string, string> DeepCopy(this Dictionary<string, string> source)
    {
      ...
      var tmp38 = new Dictionary<string, string>(source.Count);
      foreach (var pair in source)
        tmp38.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value : null);
      return tmp38;
    }
