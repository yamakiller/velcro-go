...
func NewLoginServiceProcessor(handler LoginService) *LoginServiceProcessor {
  ...
  self8 := &LoginServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self8.processorMap["OnSignIn"] = &loginServiceProcessorOnSignIn{handler:handler}
  self8.processorMap["OnSignOut"] = &loginServiceProcessorOnSignOut{handler:handler}
return self8
}
...
func (p *loginServiceProcessorOnSignIn) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.OnSignIn(ctx, args.Req); err2 != nil {
    ...
    _exc11 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing OnSignIn: " + err2.Error())
...
func (p *loginServiceProcessorOnSignOut) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.OnSignOut(ctx, args.Req); err2 != nil {
    ...
    _exc13 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing OnSignOut: " + err2.Error())
