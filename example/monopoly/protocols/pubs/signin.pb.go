...
type SignInResp struct {
	...
	Externs     map[string]string `protobuf:"bytes,3,rep,name=externs,proto3" json:"externs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *SignInResp) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *SignInResp) GetDisplayName() string {
	if x != nil {
...
func (x *SignInResp) GetExterns() map[string]string {
	if x != nil {
		return x.Externs
	}
	return nil
...
var file_signin_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04,
	0x70, 0x75, 0x62, 0x73, 0x22, 0x1e, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x12, 0x14,
	0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xb5, 0x01, 0x0a, 0x0a, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52,
	...
	0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x65, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x70, 0x75, 0x62, 0x73, 0x2e,
	0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x73,
	0x1a, 0x3a, 0x0a, 0x0c, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
...
var file_signin_proto_goTypes = []interface{}{
	(*SignIn)(nil),     // 0: pubs.SignIn
	(*SignInResp)(nil), // 1: pubs.SignInResp
	nil,                // 2: pubs.SignInResp.ExternsEntry
}
var file_signin_proto_depIdxs = []int32{
	2, // 0: pubs.SignInResp.externs:type_name -> pubs.SignInResp.ExternsEntry
