...
// 	protoc        v4.25.1
// source: network/proto/client_id.proto
...
var (
	file_network_proto_client_id_proto_rawDescOnce sync.Once
	file_network_proto_client_id_proto_rawDescData = file_network_proto_client_id_proto_rawDesc
)

func file_network_proto_client_id_proto_rawDescGZIP() []byte {
	file_network_proto_client_id_proto_rawDescOnce.Do(func() {
		file_network_proto_client_id_proto_rawDescData = protoimpl.X.CompressGZIP(file_network_proto_client_id_proto_rawDescData)
	})
	return file_network_proto_client_id_proto_rawDescData
}
...
func init() { file_network_proto_client_id_proto_init() }
func file_network_proto_client_id_proto_init() {
	if File_network_proto_client_id_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_network_proto_client_id_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_network_proto_client_id_proto_goTypes,
		DependencyIndexes: file_network_proto_client_id_proto_depIdxs,
		MessageInfos:      file_network_proto_client_id_proto_msgTypes,
	}.Build()
	File_network_proto_client_id_proto = out.File
	file_network_proto_client_id_proto_rawDesc = nil
	file_network_proto_client_id_proto_goTypes = nil
	file_network_proto_client_id_proto_depIdxs = nil
}
