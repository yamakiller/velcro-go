...
::生成cluster proto
echo %GO_COMPILER_PATH% --go_out=.\cluster\protocols --proto_path=.\cluster\proto --proto_path=.\network\proto ping.proto pubkey.proto forward.proto register.proto closed.proto backward.proto error.proto client_request_message.proto
%GO_COMPILER_PATH% --go_out=.\cluster\protocols --proto_path=.\cluster\proto --proto_path=./network/proto ping.proto pubkey.proto forward.proto register.proto closed.proto backward.proto error.proto client_request_message.proto
