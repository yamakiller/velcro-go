...
func NewRpcRequestMessageProxy(rcc *RpcClientConn)*RpcRequestMessageProxy{
...
func (slf *RpcRequestMessageProxy) UnMarshal(msg []byte) error {
	slf.iprot.Release()
	slf.iprot.Write(msg)
	_,_, err := messages.UnMarshalTStruct(context.Background(),slf.iprot,slf.message)
	if err != nil{
...
func (slf *RpcRequestMessageProxy) Method(ctx network.Context, seqId int32, _ int64) error {
...
func NewRpcResponseMessageProxy(rcc *RpcClientConn)*RpcResponseMessageProxy{
