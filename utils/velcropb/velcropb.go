...
type Reader interface {
	Read(b []byte, category int8, number int32) (int, error)
}
...
type Protocol interface {
	WriteMessage(b []byte, number int32, writer Writer) (n int)
	...
	ReadMessage(buf []byte, _type int8, reader Reader) (n int, err error)
